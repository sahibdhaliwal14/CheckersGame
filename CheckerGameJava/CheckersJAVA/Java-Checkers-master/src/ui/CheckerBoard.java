...
/**
 * The code CheckerBoard class is a graphical user interface component that is
 * capable of drawing any checkers game state. It also handles player turns. For
 * human players, this means interacting with and selecting tiles on the checker
 * board. For non-human players, this means using the logic implemented by the
 * specified player object itself is used.
 */
public class CheckerBoard extends JButton {
	...
	public void setPlayer1(Player player1) {
		...
		/*
		 * if (game.isP1Turn() && !this.player1.isHuman()) { this.selected = null; }
		 */
	}
