...
/**
 * The code MoveLogic class determines what a valid move is. It fully implements
 * all the rules of checkers.
 */
public class MoveLogic {
	 ...
	 * 
	 * game the game to check against. startIndex the start index of the move.
	 * endIndex the end index of the move. true if the move is legal according to
	 * the rules of checkers. link #isValidMove(Board, boolean, int, int, int)
	 */
	 ...
	 * checker). board the current board state. checker the point where the test
	 * checker is located at. true if and only if the checker at the point is safe.
	 */
