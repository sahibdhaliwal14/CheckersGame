...
public class MoveGenerator {
	 ...
	 *  startIndex the center index to look for moves around.
	 ...
	 *  the list of points such that the start to a given point represents a
	 *         skip available.
	 */
	 ...
	 * 
	 *  board      the board to look for available skips.
	 * startIndex the center index to look for skips around.
	 *  the list of points such that the start to a given point represents a
	 *         skip available.
	 * link #getSkips(Board, Point)
	 */
	 ...
	 * true if and only if the skip can be performed.
	 */
